...
namespace UniRx.Operators
{
    internal class WhereObservable<T> : OperatorObservableBase<T>
    {
        ...
        {
            if (predicate != null) return new WhereObservable<T>(source, x => predicate(x) && combinePredicate(x));
        ...
        {
            if (predicate != null) return new WhereSelectObservable<T, TR>(source, predicate, selector);
        ...
        {
            if (predicate != null) return source.Subscribe(new Where(this, observer, cancel));
