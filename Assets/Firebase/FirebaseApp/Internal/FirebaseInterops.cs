      ...
      UnityEngine.Debug.LogError(message);
        ...
        internal static async Task<string> GetAppCheckTokenAsync(FirebaseApp firebaseApp, bool limitedUse = false)
        {
            ...
            try
            {
                ...
                var finalToken = _appCheckTokenTokenProperty.GetValue(tokenResult) as string;
                return finalToken;
            }
            catch (Exception e)
            {
        ...
        internal static async Task AddFirebaseTokensAsync(HttpRequestMessage request, FirebaseApp firebaseApp,
            string authTokenPrefix = "Firebase", bool limitedUseAppCheckTokens = false)
        {
            var appCheckToken = await GetAppCheckTokenAsync(firebaseApp, limitedUseAppCheckTokens);
